						...
						<ul class="userpgcategory fa-ul">
							@if(isset($categories))
								@if(count($categories)>0)
									...
									<li><a href='{{url("/post-classified-ad/".preg_replace("/\s+/","", $category->maincategory)."/".$category->id)}}'>{!!html_entity_decode($category->icons)!!}{{$category->maincategory}}</a></li>
									@endforeach
								@else
				...
				<div class="card">
					...
					<div class="card-body">
						<ul class="nav nav-tabs">
							<li class="nav-item">
								<a href="#home" class="nav-link" data-togle="tab">Cars & Bikes</a>
							</li>
						</ul>
